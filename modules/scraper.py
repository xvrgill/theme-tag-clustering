...
class InsightPageScraper(AEMScraper):
    ...
    def __init__(self, aem_path: str, audience_role: str):
        """ Scraper for AEM Insight pages specifically.

        Child metaclass of AEMScraper.
    ...
    def parse_publish_date(soup: BeautifulSoup) -> str:
        """ Parses publish date from BeautifulSoup object.

        :param soup: Instance of a BeautifulSoup object
        :return: Publish date of AEM Insight page
        :rtype: str
        """
    ...
    def scrape(self):
        """ Runs scraper methods on class instance.
